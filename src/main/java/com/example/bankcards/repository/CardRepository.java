...
public interface CardRepository extends JpaRepository<Card, Long>{
    ...
    Page<Card> findByUserIdAndBalanceGreaterThan(@Param("userId") Long userId, 
                                               @Param("minBalance") Double minBalance, 
                                               Pageable pageable);
    
    @Query("SELECT c FROM Card c WHERE c.user.id = :userId AND c.balance < :maxBalance")
    Page<Card> findByUserIdAndBalanceLessThan(@Param("userId") Long userId, 
    ...
    Page<Card> findByUserIdAndCardHolderContaining(@Param("userId") Long userId, 
